...
void main() {
  group('TerminalSessionController', () {
    ...
    testWidgets('TerminalSurface defaults to visiblePassword keyboard type', (
      tester,
    ) async {
      final controller = _RecordingTerminalSessionController();
      final focusNode = FocusNode();
      ...
      expect(view.keyboardType, TextInputType.visiblePassword);

      await tester.pump(const Duration(milliseconds: 250));
    });

    testWidgets('TerminalSurface uses standard keyboard type when enabled', (
      tester,
    ) async {
      final controller = _RecordingTerminalSessionController();
      final focusNode = FocusNode();
      ...
      final view = tester.widget<TerminalView>(find.byType(TerminalView));
      expect(view.keyboardType, TextInputType.text);
